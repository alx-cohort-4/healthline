  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white px-4">
      ...
      >
        ...
        <p className="text-sm text-center text-gray-600 mb-6">Enter your email and password to login</p>

        <div className="mb-4">
          <p className="text-sm text-gray-600 mb-1">Email<span className="text-red-500">*</span></p>
          <input
            type="email"
            name="email"
        ...
        <div className="mb-2 relative">
          <p className="text-sm text-gray-600 mb-1">Password<span className="text-red-500">*</span></p>
          <input
