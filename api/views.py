...
from .tasks import send_email_password_reset, decode_token_val, send_email, send_otp_for_login
...
class TenantLoginView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            # send_otp_for_login(email=clinic_email) 
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            if not tenant.token_valid and tenant.email_verified:
                ...
                return Response(data={'success': 'password has been changed successfully', 'token': token.key}, status=status.HTTP_200_OK)           
